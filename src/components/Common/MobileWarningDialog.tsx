      ...
      <Dialog open={open} onClose={handleClose} TransitionComponent={FadeTransition}>
        <DialogContent sx={{ backgroundColor: '#040414', width: '324px', padding: '15px', border: '1px solid #414166', borderRadius: '15px' }}>
          <BoxWrapper>
            ...
            <Box width='251px' lineHeight={0.9} margin='0 auto' mt='15px' textAlign='center'>
              <Typography variant='p' color='#989898'>
                Clone Markets web app is not yet available on smaller screens. Please enlarge your screen or visit us from a device with a larger screen. We apologize for any inconvenience!
              </Typography>
            </Box>
