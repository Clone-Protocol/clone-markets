...
export const fetchMarketDetail = async ({
  ...
  const oracleUsdcPrice = pythOraclePrices[0] //oraclePrices.get("Crypto.USDC/USD")!
  const oraclePrice = pythOraclePrices[pool.assetInfo.oracleInfoIndex]  //rescaleFactor * oraclePrices.get(pythSymbol)! / oracleUsdcPrice;
