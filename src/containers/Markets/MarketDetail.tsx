			...
			{asset ? (
				<Stack mb={2} direction="column" pl={isMobileOnSize ? 0 : 5} pt={isMobileOnSize ? 5 : 1} pb={1} maxWidth={isMobileOnSize ? '380px' : '750px'}>
					...
					<Box marginBottom='40px' padding='10px'>
						...
						<a href={`https://docs.clone.so/solana-devnet-guide/classets-devnet/${asset.tickerSymbol.toLowerCase()}`} target='_blank' rel="noreferrer"><Typography variant='p_lg' color='#00ff99'>...read more</Typography></a>
					</Box>
				</Stack>
			) : (
				<></>
