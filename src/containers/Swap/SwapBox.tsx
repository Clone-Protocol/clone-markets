...
const SwapBox = () => {
  ...
  return (
    <StyledPaper variant="outlined">
      <Box>
        <PairInput tickerIcon={fromPair.tickerIcon} tickerName={fromPair.tickerName} tickerSymbol={fromPair.tickerSymbol} balance={fromPair.balance} value={fromPair.amount} onChange={onChangeFrom} />
      </Box>
      <Box display="flex" justifyContent="center">
        <SwapButton><Image src={downArrowIcon} /></SwapButton>
      </Box>
      <Box>
        <PairInput tickerIcon={toPair.tickerIcon} tickerName={toPair.tickerName} tickerSymbol={toPair.tickerSymbol} balance={toPair.balance} value={toPair.amount} />
      </Box>
